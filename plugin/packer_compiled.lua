...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'symbols-outline.nvim', 'targets.vim', 'vim-easymotion', 'bufferline.nvim', 'vim-move', 'incsearch-easymotion.vim', 'incsearch-fuzzy.vim', 'vista.vim', 'incsearch.vim', 'which-key.nvim', 'nvim-autopairs', 'vim-easy-align', 'hop', 'nvim-toggleterm.lua', 'nvim-ts-rainbow'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
