...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'bufferline.nvim', 'symbols-outline.nvim', 'targets.vim', 'hop', 'incsearch-easymotion.vim', 'incsearch-fuzzy.vim', 'incsearch.vim', 'vim-easy-align', 'vim-easymotion', 'nvim-autopairs', 'vim-move', 'vista.vim', 'which-key.nvim', 'nvim-ts-rainbow', 'nvim-toggleterm.lua'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
