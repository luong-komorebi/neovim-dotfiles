...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'vista.vim', 'nvim-autopairs', 'which-key.nvim', 'hop', 'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'symbols-outline.nvim', 'vim-easy-align', 'vim-easymotion', 'bufferline.nvim', 'incsearch.vim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
