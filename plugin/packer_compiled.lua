...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'incsearch.vim', 'nvim-autopairs', 'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'hop', 'vista.vim', 'which-key.nvim', 'vim-easy-align', 'symbols-outline.nvim', 'vim-easymotion', 'bufferline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
