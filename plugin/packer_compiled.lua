...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-yardoc', 'vim-projectionist', 'vim-rake', 'vim-bundler', 'vim-cucumber'}, { ft = "ruby" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'incsearch-easymotion.vim', 'incsearch-fuzzy.vim', 'incsearch.vim', 'nvim-autopairs', 'bufferline.nvim', 'nvim-toggleterm.lua', 'which-key.nvim', 'vista.vim', 'nvim-ts-rainbow', 'symbols-outline.nvim', 'targets.vim', 'vim-move', 'hop', 'vim-easy-align', 'vim-easymotion'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
