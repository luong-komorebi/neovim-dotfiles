...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-bundler', 'vim-cucumber', 'vim-projectionist', 'vim-yardoc', 'vim-rake'}, { ft = "ruby" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'numb.nvim', 'nvim-comment', 'gitsigns.nvim', 'octo.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au CursorMoved * ++once lua require("packer.load")({'vim-matchup'}, { event = "CursorMoved *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-lspinstall'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'vim-easy-align', 'vim-easymotion', 'bufferline.nvim', 'vim-move', 'incsearch-easymotion.vim', 'vista.vim', 'nvim-autopairs', 'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'incsearch-fuzzy.vim', 'incsearch.vim', 'hop', 'which-key.nvim', 'symbols-outline.nvim', 'targets.vim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
