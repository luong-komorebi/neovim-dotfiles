...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-rake', 'vim-yardoc', 'vim-cucumber', 'vim-projectionist', 'vim-bundler'}, { ft = "ruby" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'symbols-outline.nvim', 'targets.vim', 'hop', 'bufferline.nvim', 'vista.vim', 'vim-easymotion', 'vim-move', 'incsearch-easymotion.vim', 'incsearch-fuzzy.vim', 'incsearch.vim', 'nvim-autopairs', 'which-key.nvim', 'vim-easy-align'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
