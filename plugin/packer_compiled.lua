...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-bundler', 'vim-projectionist', 'vim-rake', 'vim-yardoc', 'vim-cucumber'}, { ft = "ruby" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-toggleterm.lua', 'hop', 'nvim-ts-rainbow', 'bufferline.nvim', 'symbols-outline.nvim', 'targets.vim', 'vim-easymotion', 'vim-move', 'vista.vim', 'incsearch-fuzzy.vim', 'incsearch-easymotion.vim', 'vim-easy-align', 'incsearch.vim', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
