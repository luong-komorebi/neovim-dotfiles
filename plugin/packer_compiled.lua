...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'bufferline.nvim', 'nvim-toggleterm.lua', 'symbols-outline.nvim', 'nvim-ts-rainbow', 'vista.vim', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
