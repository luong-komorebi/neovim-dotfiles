...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'vista.vim', 'which-key.nvim', 'nvim-autopairs', 'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'symbols-outline.nvim', 'vim-easy-align', 'vim-easymotion', 'hop', 'bufferline.nvim', 'incsearch.vim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
