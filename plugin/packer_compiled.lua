...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-projectionist', 'vim-yardoc', 'vim-rake', 'vim-bundler', 'vim-cucumber'}, { ft = "ruby" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'incsearch-easymotion.vim', 'incsearch-fuzzy.vim', 'incsearch.vim', 'vim-move', 'hop', 'vista.vim', 'which-key.nvim', 'targets.vim', 'symbols-outline.nvim', 'nvim-autopairs', 'nvim-toggleterm.lua', 'bufferline.nvim', 'nvim-ts-rainbow', 'vim-easy-align', 'vim-easymotion'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
