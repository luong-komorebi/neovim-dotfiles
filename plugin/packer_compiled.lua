...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-cucumber', 'vim-projectionist', 'vim-bundler', 'vim-yardoc', 'vim-rake'}, { ft = "ruby" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'symbols-outline.nvim', 'targets.vim', 'hop', 'vim-easymotion', 'incsearch-easymotion.vim', 'incsearch-fuzzy.vim', 'incsearch.vim', 'vim-move', 'vim-easy-align', 'bufferline.nvim', 'vista.vim', 'which-key.nvim', 'nvim-autopairs', 'nvim-toggleterm.lua', 'nvim-ts-rainbow'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-lspinstall'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'numb.nvim', 'gitsigns.nvim', 'nvim-comment', 'octo.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
