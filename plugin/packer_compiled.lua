...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-toggleterm.lua', 'vim-easy-align', 'symbols-outline.nvim', 'bufferline.nvim', 'vista.vim', 'which-key.nvim', 'hop', 'nvim-ts-rainbow', 'incsearch.vim', 'vim-easymotion'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
