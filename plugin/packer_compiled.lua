...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'bufferline.nvim', 'symbols-outline.nvim', 'nvim-ts-rainbow', 'vista.vim', 'nvim-toggleterm.lua', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
