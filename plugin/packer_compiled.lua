...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-bundler', 'vim-yardoc', 'vim-projectionist', 'vim-rake', 'vim-cucumber'}, { ft = "ruby" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'vista.vim', 'nvim-autopairs', 'which-key.nvim', 'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'symbols-outline.nvim', 'targets.vim', 'hop', 'bufferline.nvim', 'vim-easy-align', 'incsearch.vim', 'incsearch-fuzzy.vim', 'vim-easymotion', 'incsearch-easymotion.vim', 'vim-move'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
