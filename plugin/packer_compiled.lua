...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-comment', 'octo.nvim', 'gitsigns.nvim', 'numb.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'symbols-outline.nvim', 'targets.vim', 'bufferline.nvim', 'vim-move', 'vista.vim', 'incsearch-easymotion.vim', 'incsearch-fuzzy.vim', 'incsearch.vim', 'vim-easymotion', 'which-key.nvim', 'vim-easy-align', 'hop', 'nvim-autopairs'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
