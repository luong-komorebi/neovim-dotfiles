...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'incsearch.vim', 'hop', 'nvim-autopairs', 'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'which-key.nvim', 'vim-easymotion', 'symbols-outline.nvim', 'vista.vim', 'vim-easy-align', 'bufferline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
