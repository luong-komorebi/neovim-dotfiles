...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'incsearch-easymotion.vim', 'incsearch-fuzzy.vim', 'incsearch.vim', 'nvim-ts-rainbow', 'hop', 'symbols-outline.nvim', 'targets.vim', 'nvim-toggleterm.lua', 'vim-easy-align', 'vim-easymotion', 'vim-move', 'nvim-autopairs', 'vista.vim', 'which-key.nvim', 'bufferline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
