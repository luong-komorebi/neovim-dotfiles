...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-rake', 'vim-cucumber', 'vim-yardoc', 'vim-bundler', 'vim-projectionist'}, { ft = "ruby" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'hop', 'vim-move', 'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'symbols-outline.nvim', 'targets.vim', 'bufferline.nvim', 'nvim-autopairs', 'vim-easy-align', 'vim-easymotion', 'vista.vim', 'which-key.nvim', 'incsearch-easymotion.vim', 'incsearch-fuzzy.vim', 'incsearch.vim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
