...
try_loadstring("\27LJ\2\n<\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\19luong.nvim-cmp\frequire\0", "config", "nvim-cmp")
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-toggleterm.lua', 'hop', 'symbols-outline.nvim', 'bufferline.nvim', 'vim-easy-align', 'vim-easymotion', 'vista.vim', 'incsearch.vim', 'nvim-ts-rainbow', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
