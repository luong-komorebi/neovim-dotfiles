...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-bundler', 'vim-projectionist', 'vim-rake', 'vim-cucumber', 'vim-yardoc'}, { ft = "ruby" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'numb.nvim', 'octo.nvim', 'nvim-comment'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'vista.vim', 'which-key.nvim', 'symbols-outline.nvim', 'targets.vim', 'vim-easy-align', 'vim-easymotion', 'vim-move', 'incsearch-easymotion.vim', 'incsearch-fuzzy.vim', 'incsearch.vim', 'nvim-autopairs', 'hop', 'bufferline.nvim', 'nvim-toggleterm.lua', 'nvim-ts-rainbow'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
