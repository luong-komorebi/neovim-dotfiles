...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-bundler', 'vim-yardoc', 'vim-rake', 'vim-projectionist', 'vim-cucumber'}, { ft = "ruby" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'bufferline.nvim', 'vim-easy-align', 'vim-easymotion', 'incsearch-easymotion.vim', 'incsearch.vim', 'nvim-autopairs', 'hop', 'vista.vim', 'which-key.nvim', 'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'incsearch-fuzzy.vim', 'vim-move', 'symbols-outline.nvim', 'targets.vim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
