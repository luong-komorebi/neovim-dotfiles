...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'numb.nvim', 'octo.nvim', 'nvim-comment', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'which-key.nvim', 'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'bufferline.nvim', 'symbols-outline.nvim', 'vista.vim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
