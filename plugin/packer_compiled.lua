...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'bufferline.nvim', 'symbols-outline.nvim', 'vim-easy-align', 'nvim-autopairs', 'hop', 'which-key.nvim', 'incsearch.vim', 'vista.vim', 'vim-easymotion', 'nvim-toggleterm.lua', 'nvim-ts-rainbow'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
