...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-yardoc', 'vim-bundler', 'vim-cucumber', 'vim-projectionist', 'vim-rake'}, { ft = "ruby" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'vista.vim', 'which-key.nvim', 'bufferline.nvim', 'nvim-toggleterm.lua', 'hop', 'nvim-ts-rainbow', 'incsearch-easymotion.vim', 'incsearch-fuzzy.vim', 'symbols-outline.nvim', 'targets.vim', 'vim-easy-align', 'vim-easymotion', 'vim-move', 'incsearch.vim', 'nvim-autopairs'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
