...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-bundler', 'vim-cucumber', 'vim-projectionist', 'vim-rake', 'vim-yardoc'}, { ft = "ruby" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-comment', 'numb.nvim', 'octo.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au CursorMoved * ++once lua require("packer.load")({'vim-matchup'}, { event = "CursorMoved *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'symbols-outline.nvim', 'targets.vim', 'bufferline.nvim', 'incsearch-easymotion.vim', 'incsearch-fuzzy.vim', 'incsearch.vim', 'vim-easy-align', 'vim-easymotion', 'nvim-autopairs', 'hop', 'vim-move', 'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'vista.vim', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
