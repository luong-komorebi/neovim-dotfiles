...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'which-key.nvim', 'nvim-ts-rainbow', 'nvim-toggleterm.lua', 'bufferline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
