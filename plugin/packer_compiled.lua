...
_G.packer_plugins = {
  ...
  rainbow = {
    ...
    loaded = true,
    path = "/Users/eh/.local/share/nvim/site/pack/packer/start/rainbow"
  },
  ["rust-tools.nvim"] = {
    loaded = true,
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-toggleterm.lua', 'bufferline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
