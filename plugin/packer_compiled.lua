...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-autopairs', 'vista.vim', 'which-key.nvim', 'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'symbols-outline.nvim', 'hop', 'vim-easymotion', 'vim-easy-align', 'incsearch.vim', 'bufferline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
