...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'targets.vim', 'vim-easy-align', 'hop', 'bufferline.nvim', 'incsearch-easymotion.vim', 'incsearch-fuzzy.vim', 'incsearch.vim', 'vim-move', 'which-key.nvim', 'nvim-autopairs', 'nvim-toggleterm.lua', 'vim-easymotion', 'nvim-ts-rainbow', 'vista.vim', 'symbols-outline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'lsp_signature.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-comment', 'octo.nvim', 'numb.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
