...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'symbols-outline.nvim', 'vim-easy-align', 'bufferline.nvim', 'which-key.nvim', 'incsearch.vim', 'nvim-autopairs', 'vista.vim', 'hop', 'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'vim-easymotion'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
