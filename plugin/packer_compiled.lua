...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'vim-move', 'hop', 'incsearch-easymotion.vim', 'incsearch-fuzzy.vim', 'incsearch.vim', 'vista.vim', 'which-key.nvim', 'nvim-autopairs', 'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'symbols-outline.nvim', 'targets.vim', 'vim-easy-align', 'vim-easymotion', 'bufferline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
