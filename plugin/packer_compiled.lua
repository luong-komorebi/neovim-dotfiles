...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-cucumber', 'vim-projectionist', 'vim-rake', 'vim-yardoc', 'vim-bundler'}, { ft = "ruby" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'symbols-outline.nvim', 'targets.vim', 'vim-easy-align', 'bufferline.nvim', 'vim-easymotion', 'vim-move', 'hop', 'incsearch-easymotion.vim', 'incsearch-fuzzy.vim', 'vista.vim', 'incsearch.vim', 'which-key.nvim', 'nvim-autopairs'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
