...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'vim-easy-align', 'vim-easymotion', 'bufferline.nvim', 'incsearch.vim', 'vista.vim', 'which-key.nvim', 'nvim-autopairs', 'hop', 'nvim-toggleterm.lua', 'nvim-ts-rainbow', 'symbols-outline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
