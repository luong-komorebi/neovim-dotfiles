...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-ts-rainbow', 'symbols-outline.nvim', 'vim-easy-align', 'vim-easymotion', 'bufferline.nvim', 'incsearch.vim', 'vista.vim', 'which-key.nvim', 'hop', 'nvim-autopairs', 'nvim-toggleterm.lua'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
