...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'octo.nvim', 'nvim-comment'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertCharPre * ++once lua require("packer.load")({'friendly-snippets'}, { event = "InsertCharPre *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'bufferline.nvim', 'nvim-toggleterm.lua', 'which-key.nvim', 'nvim-ts-rainbow'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
