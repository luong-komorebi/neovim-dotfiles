...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'octo.nvim', 'numb.nvim', 'nvim-comment'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au CursorMoved * ++once lua require("packer.load")({'vim-matchup'}, { event = "CursorMoved *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'symbols-outline.nvim', 'vim-easy-align', 'vim-easymotion', 'incsearch.vim', 'nvim-ts-rainbow', 'vista.vim', 'nvim-autopairs', 'which-key.nvim', 'bufferline.nvim', 'hop', 'nvim-toggleterm.lua'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
